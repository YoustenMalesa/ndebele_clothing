<?php
    require 'connect.php';
    $clothes_query = mysqli_query($connect, 'select * from tbl_clothes');
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarExample">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="adminops_accessories.php">Accessories</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="row">
                    <table class="table">
                         <thead>
                          ...
                          <tbody> 
                            <?php while($product = mysqli_fetch_object($clothes_query)) {
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger" href="adminops.php?action=del&cat=clothes&id=<?php echo $product->id ?>">Del</a>
                                    </td>
                                </tr>
                            <?php 
