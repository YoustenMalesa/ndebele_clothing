                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a class="btn btn-danger" href="adminops.php?action=del&cat=shoes&id=<?php echo $product->id ?>">Del</a>
                                    </td>
                                </tr>
                            <?php 
                    ...
                    <div id="div-forms">
                        ...
                        <!-- Begin # Login Form -->
                            <div class="modal-body">
                                ...
                                <input id="cat" name="cat" type="hidden" value="shoes">
